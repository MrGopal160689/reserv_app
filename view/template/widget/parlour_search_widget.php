...
<form id="parlor_search_form" method="post" action="search.php">
	<ul id="search_form_fields">
		...
		<li class="input_field">
			...
			<input type="text" id="area_search_field" placeholder="Enter your area" autocomplete="off"/>
		...
		<li class="input_field">
			...
			<input type="text" id="service_search_field" placeholder="Enter service" autocomplete="off"/>
